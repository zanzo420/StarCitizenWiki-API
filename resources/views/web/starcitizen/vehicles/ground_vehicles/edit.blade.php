    ...
    <div class="row">
        <div class="col-12 col-xl-6">
            @component('components.card', [
                ...
                @slot('title')
                    <h4 class="mb-0">@lang('Fahrzeugdaten') <small class="float-right mt-1">@lang('Letztes Update')
                            : {{ $groundVehicle->updated_at->diffForHumans() }}</small></h4>
                @endslot
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            @component('components.forms.form-group', [
                                ...
                                @slot('value')
                                    {{
                                        $groundVehicle->foci->transform(function(Focus $focus) {
